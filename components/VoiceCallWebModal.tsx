...
import './VoiceCallModal.css'; // We'll create CSS for styling
...
const VoiceCallWebModal: React.FC<VoiceCallModalProps> = ({ 
    visible, 
    onClose, 
    currentUserId, 
    targetUserId, 
    ...
    const [remoteUserConnected, setRemoteUserConnected] = useState<boolean>(false);
    ...
    const adjustVolume = async (volume: number): Promise<void> => {
    ...
    const getConnectionQualityIcon = (): string => {
